                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="flex gap-2">
                      <Input value="East Repair Inc." readOnly />
              ...
              <div className="mb-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <Input value="US-001" readOnly />
                  </div>
                  <div>
                    <Label>Invoice date</Label>
                    <div className="flex gap-2">
                      <Input value="11/02/2019" readOnly />
                      <Button size="icon" variant="outline">
                  ...
                  <div>
                    ...
                    <div className="flex gap-2">
                      <Input value="26/02/2019" readOnly />
                      <Button size="icon" variant="outline">
                        <CalendarIcon className="h-4 w-4" />
                      </Button>
                    </div>
                  ...
                  <div>
                    ...
                    <Input className="h-24" placeholder="Enter invoice description" value="Invoice of East Repair Inc." />
                  </div>
                  <div className="flex items-center gap-2">
                    <Checkbox id="capture" />
        ...
        <div className="relative flex-1">
          ...
          {isDropdownOpen && (
            <div className="absolute z-10 w-full mt-1 bg-white border rounded-md shadow-lg">
              <div className="p-2 hover:bg-gray-100 cursor-pointer" onClick={() => handleApproverSelect("AP Manager", "apmgr@onspot.com")}>
                <div className="font-medium">AP Manager</div>
                <div className="text-sm text-gray-600">apmgr@onspot.com</div>
              </div>
              <div className="p-2 hover:bg-gray-100 cursor-pointer" onClick={() => handleApproverSelect("CFO", "cfo@onspot.com")}>
                <div className="font-medium">CFO</div>
                <div className="text-sm text-gray-600">cfo@onspot.com</div>
              </div>
              <div className="p-2 hover:bg-gray-100 cursor-pointer" onClick={() => handleApproverSelect("Senior AP Analyst", "sranalyst@onspot.com")}>
